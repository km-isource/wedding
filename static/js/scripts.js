            ...
            $(".submit_form").on("click", function (e) {
                ...
                $fields.each(function () {
                    ...
                    if ($field.attr("type") === "hidden") {
                        ...
                        if ($field.attr("type") === "checkbox" && $field.closest("fieldset").hasClass("required") && !$field.is(":checked")) {
                            $field.addClass("is-invalid");
                            error = true;
                        } else if ($field.hasClass("required") && $field.val() === "" && $field.attr("type") !== "checkbox") {
                            $field.addClass("is-invalid");
                            error = true;
                        } else if ($field.hasClass("required") && $field.attr("type") === "radio" && !$("input[name='" + $field.attr("name") + "']:checked").length) {
                            $("input[name='" + $field.attr("name") + "']").addClass("is-invalid");
                            error = true;
                        } else if ($field.attr("type") === "email" && $field.val() !== "" && !re.test($field.val())) {
                            $field.addClass("is-invalid");
                            error = true;
                        } else {
                            ...
                            if ($field.attr("type") === "radio") {
                                ...
                                html += "&" + $field.attr("name") + "=" + encodeHtml($field.val());
                            }
                            len += 1;
                        }
                    }
                ...
                if (!error && !$_self.sendingMail) {
                    ...
                    $submit_btn.append('<i class="fas fa-spinner fa-spin after"></i>').addClass("disabled");
